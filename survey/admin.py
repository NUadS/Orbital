...
from .models import GenderFilter,SingaporeanFilter, FacultyFilter, YearFilter, ResidentialFilter,UploadSurvey,CompletedSurveys, TotalPoints, Reward, RedeemedRewards, UsedRewards, Report
